MAXREQ = 4 # maximum number of queries per API request
APIkey = "ceb3f491c73a4b5396e1102fdb7c042a"
baseURL = "http://lapi.transitchicago.com/api/1.0/ttarrivals.aspx?key=" + APIkey

trainStations = {40830: "18th",
...
30032: ("Ashland (Green, Pink Lines)", "West", 40170),
30033: ("Ashland (Green, Pink Lines)", "East", 40170),
...
30038: ("Randolph/Wabash", "North (Outer Loop)", 40200),
30039: ("Randolph/Wabash", "South (Inner Loop)", 40200),
